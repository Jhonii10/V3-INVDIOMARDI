...
const styles = `inline-flex items-center justify-center h-12 w-12 border border-[#1c1e21] rounded-full box-border text-[#1c1e21] hover:text-white hover:border-none cursor-pointer overflow-hidden p-0 relative transition-[color,border-color,background-color] duration-[0.33s] delay-[0.5s] ease-out align-bottom z-10
