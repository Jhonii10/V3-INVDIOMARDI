...
export const Search = () => {
    ...
    const routes = [
        ...
        { path: '/categories/navidad', name: 'navidad' },
        { path: '/categories/escolar', name: 'escolar' },
        { path: '/categories/expresion-social', name: 'expresion social' },
        { path: '/categories/insumos', name: 'insumos' },
        { path: '/categories/bisuteria', name: 'bisuteria' },
        { path: '/categories/marroquineria', name: 'marroquineria' },
        { path: '/categories/cosmeticos', name: 'cosmeticos' },
        { path: '/categories/mascotas', name: 'mascotas' },
        { path: '/categories/tecnologia', name: 'tecnologia' },
